...
class CollectionsDto:
    ...
    store_collection = api.model("store_collection", {
        # TODO: Check: Follow collection spec fully
        # Must follow https://github.com/radiantearth/stac-spec/blob/master/collection-spec/collection-spec.md
        "type": fields.String(required=True, description="Collection type", example="Collection"),
        "stac_version": fields.String(required=True, description="stac version", example="1.0.0"),
        "id": fields.String(required=True, description="collection id", example="custom-landsat-c2-l2"),
        "description": fields.String(required=True, description="collection description",
                                     example="Custom Landsat Collection 2 Level 2"),
        "license": fields.String(required=True, description="collection license", example="proprietary"),
        "extent": fields.Nested(api.model("extent", {
            "spatial": fields.List(fields.Float, required=True, description="spatial extent",
                                   example=[-180, -90, 180, 90]),
            "temporal": fields.List(fields.String, required=True, description="temporal extent",
                                    example=["2021-05-05T00:00:00Z/2022-05-05T00:00:00Z"]),
        }), required=True, description="spatial and temporal extent"),
    })
